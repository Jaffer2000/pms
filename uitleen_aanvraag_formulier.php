...
if ($_POST != NULL) {
    if ($_POST['action'] == "Aanvragen") {
        ...
        if ($_POST['product'] == NULL) {
            ...
            echo '<script>';
            echo 'alert("Selecteer minstens 1 product")';
            echo '</script>';

        } elseif ($_POST['datumvan'] > $_POST['datumtot']) {

            echo '<script>';
            echo 'alert("Datum-van mag niet later zijn dan datum-tot")';
            echo '</script>';
            ...
            echo '<script>';
            echo 'alert("Aanvraag succesvol aangemaakt")';
            echo '</script>';
...
<div class="app-container">
    <div class="app-header">
        <div class="app-header-left">
            ...
            <svg class="logo" style="fill-rule:nonzero;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1249.04 346.81">
                <defs/>
                <clipPath id="ArtboardFrame">mysqli_query
    ...
    <div class="app-content">
        ...
        <div class="projects-section">
            <div class="aanvragenpaginatitel">
                <h1>Aanvraag plaatsen</h1>
            </div>
                    ...
                    <div class="uitleenaanvragenproducten">
                        ...
                        foreach($producten->getAllProducts() as $product) { ?>
                            <div class="uitleenaanvragenproduct">
                                <label class="uitleenaanvragenproductcheckbox" for="product<?php echo $product["product_id"] ?>"><?php echo $product["product_naam"] ?>
                                    <input type="checkbox" id="product<?php echo $product["product_id"] ?>" name="product[]" value="<?php echo $product["product_id"] ?>">
                                </label>
                            </div>
                        <?php } ?>
                    </div>
