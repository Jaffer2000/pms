	  ...
	  <h3>Registreer een gebruiker</h3>
		<form name="register" action="auth_register.php" method="post">
			<div class="textbox">
				...
				name="password_1" id="password_1" value="" required>
				...
				name="password_2" id="password_2" value="" required>
  ...
  <div class="box_reg">
    <h3>Gebruiker verwijderen</h3>
      ...
      <form method="POST">
        ...
        <p class="admin-box-content"><input class="form-control-number" type="number" name="id_delete_user" min=0 placeholder="User ID"><br><br>

        <button type="submit" name="delete_user" value="delete" class="projectstatusbuttondelete" onclick="return confirm('Weet je zeker dat je dit account wilt verwijderen? Deze actie kan niet ongedaan gemaakt worden. Druk op OK om te verwijderen.')";><i class="fas fa-trash-alt"></i> Gebruiker verwijderen</button>
      </form>
</div>
...
<div class="box_reg">
    <h3>Admin account verwijderen</h3>
      ...
      <form method="POST">
        ...
        <p class="admin-box-content"><input class="form-control-number" type="number" name="id_delete_admin" min=0 placeholder="Admin ID"><br><br>

        <button type="submit" name="delete_admin" value="delete" class="projectstatusbuttondelete" onclick="return confirm('Weet je zeker dat je dit account wilt verwijderen? Deze actie kan niet ongedaan gemaakt worden. Druk op OK om te verwijderen.')";><i class="fas fa-trash-alt"></i> Admin verwijderen</button>
      </form>
</div>
</div>
