...
$sql = "SELECT * FROM `project` WHERE projectcoach='Wouter Mahu';";

$wouter = mysqli_query($conn, $sql);
$resultWouter = mysqli_num_rows($wouter);

$sql = "SELECT * FROM `project` WHERE projectcoach='Sander Bruggeman';";

$sander = mysqli_query($conn, $sql);
$resultSander = mysqli_num_rows($sander);

$sql = "SELECT * FROM `project` WHERE projectcoach='Vincent Brunings';";

$vincent = mysqli_query($conn, $sql);
$resultVincent = mysqli_num_rows($vincent);

$sql = "SELECT * FROM `project` WHERE projectcoach='Gerhard Hoogendoorn';";

$gerhard = mysqli_query($conn, $sql);
$resultGerhard = mysqli_num_rows($gerhard);

$sql = "SELECT * FROM `project` WHERE projectcoach='Jesse Vermeer';";
...
$sql = "SELECT * FROM `project` WHERE opleiding='Software';";

$software = mysqli_query($conn, $sql);
$resultSoftware = mysqli_num_rows($software);


$sql = "SELECT * FROM `project` WHERE opleiding='Media';";

$media = mysqli_query($conn, $sql);
$resultMedia = mysqli_num_rows($media);

$sql = "SELECT * FROM `project` WHERE opleiding='Media & Software';";
...
<div class="app-content">
  ...
  <div class="project-boxes jsGridView">
            ...
            <div class="project-box" id="project-box" style="background-color: ', $BGcolor ,">
            <div class="project-box-content-header">

            <p class="box-content-header">' , $row['projectleider'] , '</p>
            <p class="box-content-subheader">' , $row['projectnaam'] , '</p>
            </div>

            // <button class="buttonmodal-presentie">
            // Aanwezig <i class="fas fa-chevron-circle-right"></i> 
            // </button>

            <form action="" method="post">
            <input type="submit" class="buttonmodal-presentie" name="aanwezig" value="Aanwezig" />

            <input type="submit" class="buttonmodal-presentie" name="afwezig" value="Afwezig" />
            </form>

            // <button class="buttonmodal-presentie">
            // Afwezig <i class="fas fa-chevron-circle-right"></i>
            // </button>
