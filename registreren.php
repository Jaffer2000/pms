...
<body>
  ...
  ?>
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            <form name="register" action="auth_register.php" method="post">
                                <td> <b>Gebruiker</b> </td>
                                <td> <input type="text" placeholder="Volledige naam" name="naam" id="naam" value=""
                                        class="accountboxinputadd" style="width:140px;" required> </td>
                                <td> <input type="text" placeholder="Gebruikersnaam" name="username" id="username"
                                        value="" class="accountboxinputadd" style="width:140px;" required> </td>
                                <td> <input type="text" placeholder="naam@email.com" name="email" id="email" value=""
                                        class="accountboxinputadd" required> </td>
                                ...
                                <td> <input type="password" placeholder="Wachtwoord*" name="password_1" id="password_1"
                                        value="" class="accountboxinputadd" style="width:110px;" required> </td>
                                <td> <input type="password" placeholder="Herhaal wachtwoord*" name="password_2"
                                        id="password_2" value="" class="accountboxinputadd" required> </td>
    ...
    <td> <input type="password" placeholder="Herhaal wachtwoord*" name="password_2" id="password_2" value="" class="accountboxinput" required><input type="checkbox" onclick="ShowPW2()"> </td> -->
                    ...
                    <p class="informatietekst"><i>Als je een admin / beheerder account aanmaakt krijgt deze gebruiker
                            een normaal account met admin rechten. Je hoeft dus geen extra gebruikersaccount aan te
                            maken.</i></p>
