                        ...
                        <article class="uitleenaanvraag">
                            ...
                            <div class="uitleenaanvraagbuttons">
                                <form action="uitleen_admin_aanvragen_overzicht.php" method="post">
                                    ...
                                    <input type="submit" name="action" class="uitleenaanvraagbutton uitleengoedkeuren" value="Goedkeuren" onclick="return confirm('Wil je deze aanvraag goedkeuren?')">
                                    <input type="submit" name="action" class="uitleenaanvraagbutton uitleenafkeuren" value="Afkeuren" onclick="return confirm('Wil je deze aanvraag afkeuren?')">
                                    <input type="submit" name="action" class="uitleenaanvraagbutton uitleeningeleverd" value="Ingeleverd" onclick="return confirm('Wil je deze aanvraag als ingeleverd markeren?')">
                                </form>
                            </div>
                        </article>
                    <?php } ?>
