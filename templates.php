...
$sql = "SELECT * FROM `project` WHERE `projectleider` LIKE '%".$persoonlijkepagina."%' OR `projectleden` LIKE '%".$persoonlijkepagina."%' OR `projectcoach` LIKE '%".$persoonlijkepagina."%';";
...
if ($resultCheckTickets === 1) {
  $ticketmeervoud = "ticket";
} else {
  $ticketmeervoud = "tickets";
}
...
<div class="app-content">
  ...
  <a href="templates.php" class="app-sidebar-link active">
...
<div class="projects-section-links">
      <div class="project-boxes jsGridView">

      <div class="project-box-wrapper2">
          <h1>Software Developer</h1><hr>
          <br>

          <h3>IVS Huisstijl <span class="label color-green">NIEUW</span></h3>
        
        <button class="collapsible">Logo, Icon, Kleuren & Font</button>
          <div class="content">
          <p><i class="fa-solid fa-circle-info"></i> <i>Gebruik bij voorkeur altijd de <b>SVG</b> versie van het logo. Dit voorkomt kwaliteitsverlies.</i></p><hr>

        <p>Kleurverloop: <span class="label" style="background-color:#FF9900;">#FF9900</span> > <span class="label" style="background-color:#FC7500;">#FC7500</span> = <span class="label" style="background-image: linear-gradient(to right, #FF9900, #FC7500)">Gradient</span></p><hr>
        
        <p><span class="label">SVG</span> IVS Logo kleur
          <a href="bestanden/ivs_logo_kleur.svg" download="ivs_logo_kleur.svg">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">PNG</span> IVS Logo kleur
          <a href="bestanden/ivs_logo_kleur.png" download="ivs_logo_kleur.png">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">SVG</span> IVS Logo Wit
          <a href="bestanden/ivs_logo_wit.svg" download="ivs_logo_wit.svg">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">PNG</span> IVS Logo Wit
          <a href="bestanden/ivs_logo_wit.png" download="ivs_logo_wit.png">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">SVG</span> IVS Icon kleur
          <a href="bestanden/ivs_icon_kleur.svg" download="ivs_icon_kleur.svg">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">PNG</span> IVS Icon kleur
          <a href="bestanden/ivs_icon_kleur.png" download="ivs_icon_kleur.png">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">SVG</span> IVS Icon Wit
          <a href="bestanden/ivs_icon_wit.svg" download="ivs_icon_wit.svg">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">PNG</span> IVS Icon Wit
          <a href="bestanden/ivs_icon_wit.png" download="ivs_icon_wit.png">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label">PNG</span> IVS Logo Banner Socials
          <a href="bestanden/ivs_banner_socials.png" download="ivs_banner_socials.png">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

        <p><span class="label"><i class="fa-solid fa-file-zipper"></i> ZIP</span> Font Pakket - Poppins
            <a href="bestanden/poppins.zip" download="poppins.zip">
        <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
      </div><br>

          <h3>Scrum</h3>
          
          <button class="collapsible">Scrum</button>
            <div class="content">
            <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Scrum board
            <a href="bestanden/scrumboard.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/scrumboard.pdf" download="scrumboard.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Stand up formulier
          <a href="bestanden/standupform.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/standupform.pdf" download="standupform.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Project Flow
          <a href="bestanden/project_flow_V2.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/project_flow_V2.pdf" download="project_flow_V2.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Sprint review en retrospective
          <a href="bestanden/sprintreview-form.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/sprintreview-form.pdf" download="sprintreview-form.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

          <h3>Kwalificatiedossier</h3>

          <button class="collapsible">Kwalificatiedossier</button>
          <div class="content">

              <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Checklist Werkprocessen (2020-2021)
                  <a href="bestanden/ChecklistWerkprocessen_2020-2021_SD_V2.1.0.docx" download="ChecklistWerkprocessen_2020-2021_SD_V2.1.0projectvoorstel.docx">
                      <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p>

          </div><br>

          <h3>Projectbestanden</h3>
          
          <button class="collapsible">Initiatie</button>
            <div class="content">
            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Persoonlijke Leerofferte
          <a href="bestanden/plo-template.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/plo-template.docx" download="plo-template.docx">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Sprintofferte
          <a href="bestanden/so.docx" download="so.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Projectvoorstel
          <a href="bestanden/projectvoorstel.docx" download="projectvoorstel.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Checklist initiatiegesprek (2022)
          <a href="bestanden/initiatie_ivs.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/initiatie_ivs.pdf" download="initiatie_ivs.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

        <button class="collapsible">Definitie</button>
          <div class="content">
          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Plan van Aanpak
          <a href="bestanden/pva.docx" download="pva.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-excel"></i> XLS</span> Risicoanalyse
          <a href="bestanden/risicoanalyse.xls" download="risicoanalyse.xls">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-excel"></i> XLS</span> Sprint planning
          <a href="bestanden/sprint_planning.xls" download="sprint_planning.xls">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Checklist plan van aanpak
          <a href="bestanden/checklist-pva.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
          <a href="bestanden/checklist-pva.pdf" download="checklist-pva.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

        <button class="collapsible">Ontwerp</button>
          <div class="content">
          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Functioneel ontwerp
          <a href="bestanden/fo.docx" download="fo.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Technisch ontwerp
          <a href="bestanden/to.docx" download="to.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-excel"></i> XLS</span> Usecase beschrijving
          <a href="bestanden/use-case-beschrijving.xls" download="use-case-beschrijving.xls">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Checklist FO
          <a href="bestanden/checklist_fo.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
          <a href="bestanden/checklist_fo.pdf" download="checklist_fo.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Checklist TO
          <a href="bestanden/checklist_to.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
          <a href="bestanden/checklist_to.pdf" download="checklist_to.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

        <button class="collapsible">Realisatie</button>
            <div class="content">
            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Code criteria
            <a href="bestanden/code-criteria.docx" download="code-criteria.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Programmeren in 10 stappen
          <a href="bestanden/tienstappen.docx" download="tienstappen.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

        <button class="collapsible">Implementatie</button>
            <div class="content">
            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Implementatieplan (2011)
            <a href="bestanden/Implementatieplan.doc" download="Implementatieplan.doc">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Acceptatietest (2022)
          <a href="bestanden/acceptatietest.docx" download="acceptatietest.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Testplan (1952)
          <a href="bestanden/testplan.docx" download="testplan.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></p></a><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Code review
          <a href="bestanden/code-review.docx" download="code-review.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

        <button class="collapsible">Factuur</button>
            <div class="content">
            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Factuur Template (2022)
            <a href="bestanden/factuur_template.docx" download="factuur_template.docx">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Factuur Voorbeeld (2022)
          <a href="bestanden/factuur_voorbeeld.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
          <a href="bestanden/factuur_voorbeeld.pdf" download="factuur_voorbeeld.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>

        <button class="collapsible">Onderhoud & Beheer</button>
            <div class="content">
            <p><span class="label">PNG</span> Ticket Afhandeling
            <a href="bestanden/Ticket_Afhandeling.png" download="Ticket_Afhandeling.png">
          <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>

          <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Service Level Agreement
          <a href="bestanden/sla.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
          <a href="bestanden/sla.docx" download="sla.docx">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>
      </div>
    </div>
    ...
    <div class="projects-section-rechts">
      <div class="project-boxes jsGridView">

      <div class="project-box-wrapper1">
      <h1>Mediavormgever</h1><hr>
      <br>

      <h3>Kwalificatiedossier<span class="label color-green">NIEUW</span></h3>

          <button class="collapsible">Kwalificatiedossier</button>
          <div class="content">

              <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Checklist Werkprocessen (2020-2021)
                  <a href="bestanden/Mediavormgever.pdf" download="Mediavormgever.pdf">
                      <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a></p>

          </div><br>

      <h3>Projectbestanden <span class="label color-green">NIEUW</span></h3>
          ...
          <button class="collapsible">Offerte</button>
            <div class="content">
            <p><i class="fa-solid fa-circle-info"></i> <i>Normaal wordt het font dat wordt gebruikt automatisch geladen. Lukt dit niet? Dan kan je het font pakket ook hier downloaden en gebruiken.</i></p><hr>

            <p><span class="label"><i class="fa-solid fa-file-zipper"></i> ZIP</span> Offerte Template (InDesign)
            <a href="bestanden/offerteivs.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
            <a href="bestanden/Offerte_ivs_template2022.zip" download="Offerte_ivs_template2022.zip">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p><hr>
        ...
        <h3>Overig <span class="label color-green">NIEUW</span></h3>

        <button class="collapsible">Pitch / Presentatieformulier</button>
            <div class="content">
          <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Pitch/Presentatie Observatie (2022)
          <a href="bestanden/pitch-presentatie-formulier-IVS-2022.pdf" target="_blank">
          <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i> Bekijken</button></a>
          <a href="bestanden/pitch-presentatie-formulier-IVS-2022.pdf" download="pitch-presentatie-formulier-IVS-2022.pdf">
          <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a></p>
        </div><br>
      ...
      <p class="inner">
        <strong>Update 10 oktober:</strong> Op dit moment wordt er gewerkt aan meer nieuwe templates voor mediavormgevers. De nieuwe templates worden binnenkort aan deze website toegevoegd. Tot die tijd kan je gebruikmaken van de templates op deze website: <a href="http://werkwijzer.wordmediavormgever.nl" target="_blank"><b>werkwijzer.wordmediavormgever.nl</b></a>
      </p>
    </div> -->
