            ...
            <div class="projects-section-links">
                <div class="project-boxes jsGridView">
                    ...
                    <div class="project-box-wrapper2">
                        ...
                        <div class="content">
                            <p><i class="fa-solid fa-circle-info"></i> <i>Gebruik bij voorkeur altijd de <b>SVG</b>
                                    versie van het logo. Dit voorkomt kwaliteitsverlies.</i></p>
                            <hr>

                            <p>Kleurverloop: <span class="label" style="background-color:#FF9900;">#FF9900</span> >
                                <span class="label" style="background-color:#FC7500;">#FC7500</span> = <span
                                    class="label"
                                    style="background-image: linear-gradient(to right, #FF9900, #FC7500)">Gradient</span>
                            </p>
                            <hr>

                            <p><span class="label">SVG</span> IVS Logo kleur
                                <a href="bestanden/ivs_logo_kleur.svg" download="ivs_logo_kleur.svg">
                                    <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a>
                            </p>
                            <hr>
                            ...
                            <p><span class="label"><i class="fa-solid fa-file-zipper"></i> ZIP</span> Font Pakket -
                                Poppins
                        ...
                        <div class="content">
                            <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Scrum board
                                <a href="bestanden/scrumboard.pdf" target="_blank">
                                    <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i>
                                        Bekijken</button></a>
                            ...
                            <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Sprint review en
                                retrospective
                        ...
                        <div class="content">
                            ...
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Checklist
                                Werkprocessen (2020-2021)
                                <a href="bestanden/ChecklistWerkprocessen_2020-2021_SD_V2.1.0.docx"
                                    download="ChecklistWerkprocessen_2020-2021_SD_V2.1.0projectvoorstel.docx">
                                    <button class="btn"><i class="fa-solid fa-download"></i> Download</button></a>
                            </p>
                        ...
                        <div class="content">
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Persoonlijke
                                Leerofferte
                            ...
                            <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Checklist
                                initiatiegesprek (2022)
                        ...
                        <div class="content">
                            ...
                            <p><span class="label"><i class="fa-solid fa-file-excel"></i> XLS</span> Usecase
                                beschrijving
                        ...
                        <div class="content">
                            ...
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Programmeren in 10
                                stappen
                        ...
                        <div class="content">
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Implementatieplan
                                (2011)
                            ...
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Acceptatietest
                                (2022)
                        ...
                        <div class="content">
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Factuur Template
                                (2022)
                        ...
                        <div class="content">
                            ...
                            <p><span class="label"><i class="fa-solid fa-file-word"></i> DOCX</span> Service Level
                                Agreement
            ...
            <div class="projects-section-rechts">
                <div class="project-boxes jsGridView">
                    ...
                    <div class="project-box-wrapper1">
                        ...
                        <div class="content">
                            <p><i class="fa-solid fa-circle-info"></i> <i>Normaal wordt het font dat wordt gebruikt
                                    automatisch geladen. Lukt dit niet? Dan kan je het font pakket ook hier downloaden
                                    en gebruiken.</i></p>
                            <hr>

                            <p><span class="label"><i class="fa-solid fa-file-zipper"></i> ZIP</span> Offerte Template
                                (InDesign)
                                <a href="bestanden/offerteivs.pdf" target="_blank">
                                    <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i>
                                        Bekijken</button></a>
                                <a href="bestanden/Offerte_ivs_template2022.zip"
                                    download="Offerte_ivs_template2022.zip">
                                    <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a>
                            </p>
                            <hr>
                        ...
                        <div class="content">
                            <p><span class="label"><i class="fa-solid fa-file"></i> PDF</span> Pitch/Presentatie
                                Observatie (2022)
                                <a href="bestanden/pitch-presentatie-formulier-IVS-2022.pdf" target="_blank">
                                    <button class="btn"><i class="fa-solid fa-arrow-up-right-from-square"></i>
                                        Bekijken</button></a>
                                <a href="bestanden/pitch-presentatie-formulier-IVS-2022.pdf"
                                    download="pitch-presentatie-formulier-IVS-2022.pdf">
                                    <button class="btn2"><i class="fa-solid fa-download"></i> Download</button></a>
                            </p>
                        </div><br>
