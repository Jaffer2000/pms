  ...
  <div class="projects-section">
    ...
    <div class="projects-section-line">
      ...
      <div class="item-status">
        ...
        <div class="status-type" style="margin-left:10px;"><span class="bezig" style="background: #FFFFFF"><?php echo $resultCheck; ?></span><a href="admin_projecten.php" class="filterbutton"><b style="margin-right:5px;"> Totaal Actief</b></a></div>
      </div>
    </div>
