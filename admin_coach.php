...
$sql = "SELECT * FROM `project` WHERE projectcoach='Wouter Mahu' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$wouter = mysqli_query($conn, $sql);
$resultWouter = mysqli_num_rows($wouter);

$sql = "SELECT * FROM `project` WHERE projectcoach='Sander Bruggeman' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$sander = mysqli_query($conn, $sql);
$resultSander = mysqli_num_rows($sander);

$sql = "SELECT * FROM `project` WHERE projectcoach='Vincent Brunings' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$vincent = mysqli_query($conn, $sql);
$resultVincent = mysqli_num_rows($vincent);

$sql = "SELECT * FROM `project` WHERE projectcoach='Cees-Jan Berman' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$ceesjan = mysqli_query($conn, $sql);
$resultCeesjan = mysqli_num_rows($ceesjan);

$sql = "SELECT * FROM `project` WHERE projectcoach='Jesse Vermeer' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$jesse = mysqli_query($conn, $sql);
$resultJesse = mysqli_num_rows($jesse);

$sql = "SELECT * FROM `project` WHERE projectcoach='-' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$coachloos = mysqli_query($conn, $sql);
$resultCoachloos = mysqli_num_rows($coachloos);

// Opleidingen

$sql = "SELECT * FROM `project` WHERE opleiding='Software' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$software = mysqli_query($conn, $sql);
$resultSoftware = mysqli_num_rows($software);


$sql = "SELECT * FROM `project` WHERE opleiding='Media' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";

$media = mysqli_query($conn, $sql);
$resultMedia = mysqli_num_rows($media);

$sql = "SELECT * FROM `project` WHERE opleiding='Media & Software' AND project_status!='Afgerond' AND project_status!='Gestopt' AND project_status!='On Hold' ORDER BY projectnaam;";
...
<div class="item-status" style="margin-top:-5px;">
    <span class="status-type2"> <?php
      ...
      Je bekijkt het <b>Coachoverzicht</b></span>
  </div>
...
<div class="app-content">
  ...
  <div class="projects-section">
    ...
    <div class="projects-section-line" style="margin-bottom: -15px;">
      <div class="projects-status">


      <div class="item-status">
      <form action="" method="post" class="statusformulier">
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultCeesjan; ?></span><input type="submit" class="filterbutton" name="ceesjan" value="Cees-jan"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultJesse; ?></span><input type="submit" class="filterbutton" name="jesse" value="Jesse"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultSander; ?></span><input type="submit" class="filterbutton" name="sander" value="Sander"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultVincent; ?></span><input type="submit" class="filterbutton" name="vincent" value="Vincent"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultWouter; ?></span><input type="submit" class="filterbutton" name="wouter" value="Wouter"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultCoachloos; ?></span><input type="submit" class="filterbutton" name="coachloos" value="Projecten zonder coach"></div>
      </form></div></div></div>
      ...
      <div class="item-status">
      <form action="" method="post" class="statusformulier">
      <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultSoftware; ?></span><input type="submit" class="filterbutton" name="software" value="Actieve software projecten"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultMedia; ?></span><input type="submit" class="filterbutton" name="media" value="Actieve media projecten"></div>
        <div class="status-type"><span class="bezig2" style="background: #FFFFFF"><?php echo $resultCombinatie; ?></span><input type="submit" class="filterbutton" name="combinatie" value="Actieve combinatie projecten"></div>
        </form>
      </div>
  ...
  <div class="project-boxes jsGridView">
      <?php
        ...
        } elseif (isset($_POST["ceesjan"])) {    
          $result = $ceesjan;
          $resultCheck = $resultCeesjan;
        } elseif (isset($_POST["jesse"])) {    
          $result = $jesse;
          $resultCheck = $resultJesse;
        } elseif (isset($_POST["coachloos"])) {    
          $result = $coachloos;
          $resultCheck = $resultCoachloos;
