...
<h2>Welkom <?=ucfirst($_SESSION['name'])?> 👋</h2><br><p>Op deze pagina vind je het laatste nieuws vanuit IVS en agenda updates zoals reviewdagen en activiteiten. <br> Ook de belangrijkste informatie over jouw project(en) en ticket(s) zoals contactgegevens van je klant en laatste updates kan je hier vinden.</p><br>
  </div>
  ...
  <button onclick="window.location='projects.php';" class="breakout-button" type="button">Naar projecten</button>
</article>

<article class="box-admin-portaal">
  <h1>Tickets</h1>
  <p>Status van alle openstaande en<br> afgeronde tickets bekijken.</p>
  <button onclick="window.location='tickets.php';" class="breakout-button" type="button">Naar tickets</button>
</article>
...
<div class="projects-section-header-home" style="width:100%;">
<h2>Jouw tickets</h2><br><p>Er <?php echo $zijnis; ?> op dit moment <?php echo $resultCheckTickets; ?> <?php echo $ticketmeervoud; ?> bij jou ingepland.</p><br>
  </div>
