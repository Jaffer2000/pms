...
?>
  ...
  ?>
        ...
        <div class="app-content">
            ...
            <div class="projects-section">
                <div class="projects-section-header-home-algemeen" style="width:100%;">
                    <h2>Welkom <?=ucfirst($_SESSION['name'])?> 👋</h2><br>
                    <p>Op deze pagina vind je het laatste nieuws vanuit IVS en agenda updates zoals reviewdagen en
                        activiteiten. <br> Ook de belangrijkste informatie over jouw project(en) en ticket(s) zoals
                        contactgegevens van je klant en laatste updates kan je hier vinden.</p><br>
                </div>
                <div class="project-boxes jsGridView">

                    <!-- <div class="news-box-wrapper">
    <div class="news-box" style="background-color: #141C28;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: larger; color:#FF8902;">
        <b>Reviewdag hogerejaars 22 Maart</b>
        </p>
      </div>
      <div class="box-progress-wrapper">
    <p class="news-box-text">Op 22 maart worden alle hogere jaars niet op school verwacht. Alle eerste en 2e jaars vormgevers worden wel op school verwacht. Dit heeft te maken met het bezoek aan Bruut Inc.</p><br>
    <p class="news-box-text-footer" style="opacity:50%;"><b>Wouter Mahu</b><br>27 februari 2023</p>
    <svg height="32px" width="30px" class="ivs-logo-news" stroke-miterlimit="10" style="fill-rule:nonzero;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;" version="1.1" viewBox="0 0 900 900" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:vectornator="http://vectornator.io" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs/><g id="Layer-1" vectornator:layerName="Layer 1"><path d="M706.154 46.058C693.344 46.2158 682.435 50.4501 682.435 50.4501C682.435 50.4502 580.161 79.1179 421.76 202.338C332.101 272.084 148.257 426.768 151.163 487.428C152.281 510.757 242.646 584.622 370.369 679.723C498.357 775.022 677.087 849.978 677.087 849.978C677.087 849.978 734.881 866.303 745.143 832.729C758.532 788.926 725.455 775.552 725.455 775.552L653.368 739.616C653.368 739.616 749.855 594.88 748.863 448.218C747.872 301.556 649.647 152.907 649.647 152.907L724.68 117.77C724.68 117.769 760.266 100.774 742.43 66.4215C733.862 49.9188 718.964 45.9002 706.154 46.058ZM565.933 205.133C565.933 205.133 580.941 213.132 590.738 227.892C600.535 242.653 605.232 264.147 605.232 264.147C605.232 264.147 465.594 359.509 465.089 464.668C464.5 587.536 603.604 663.832 603.605 663.832C603.605 663.832 597.658 676.936 589.652 687.949C581.647 698.961 571.592 707.753 571.592 707.753C571.592 707.753 255.263 510.829 255.263 475.689C255.263 432.162 565.934 205.133 565.933 205.133ZM637.555 341.928C637.555 341.928 648.252 368.508 648.252 464.668C648.252 537.742 637.555 587.408 637.555 587.409C637.555 587.409 554.781 526.152 554.694 464.668C554.621 413.141 637.555 341.928 637.555 341.928Z" fill="#FF8902" fill-rule="nonzero" opacity="1" stroke="none"/></g></svg>
  </div></div></div>
  ...
  <div class="news-box-wrapper">
    <div class="news-box" style="background-color: #141C28;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: larger; color:#FF8902;">
        <b>Vacature: Marketing Manager</b>
        </p>
      </div>
      <div class="box-progress-wrapper">
    <p class="news-box-text">Vanaf nu kan je je aanmelden voor de managementfunctie: Marketing Manager. Voor meer informatie over de functie of om je aan te melden kan je een mail naar mij sturen of langskomen voor meer informatie.</p><br>
    <p class="news-box-text-footer" style="opacity:50%;"><b>Tristan Verschueren</b><br>10 maart 2023</p>
    <svg height="32px" width="30px" class="ivs-logo-news" stroke-miterlimit="10" style="fill-rule:nonzero;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;" version="1.1" viewBox="0 0 900 900" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:vectornator="http://vectornator.io" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs/><g id="Layer-1" vectornator:layerName="Layer 1"><path d="M706.154 46.058C693.344 46.2158 682.435 50.4501 682.435 50.4501C682.435 50.4502 580.161 79.1179 421.76 202.338C332.101 272.084 148.257 426.768 151.163 487.428C152.281 510.757 242.646 584.622 370.369 679.723C498.357 775.022 677.087 849.978 677.087 849.978C677.087 849.978 734.881 866.303 745.143 832.729C758.532 788.926 725.455 775.552 725.455 775.552L653.368 739.616C653.368 739.616 749.855 594.88 748.863 448.218C747.872 301.556 649.647 152.907 649.647 152.907L724.68 117.77C724.68 117.769 760.266 100.774 742.43 66.4215C733.862 49.9188 718.964 45.9002 706.154 46.058ZM565.933 205.133C565.933 205.133 580.941 213.132 590.738 227.892C600.535 242.653 605.232 264.147 605.232 264.147C605.232 264.147 465.594 359.509 465.089 464.668C464.5 587.536 603.604 663.832 603.605 663.832C603.605 663.832 597.658 676.936 589.652 687.949C581.647 698.961 571.592 707.753 571.592 707.753C571.592 707.753 255.263 510.829 255.263 475.689C255.263 432.162 565.934 205.133 565.933 205.133ZM637.555 341.928C637.555 341.928 648.252 368.508 648.252 464.668C648.252 537.742 637.555 587.408 637.555 587.409C637.555 587.409 554.781 526.152 554.694 464.668C554.621 413.141 637.555 341.928 637.555 341.928Z" fill="#FF8902" fill-rule="nonzero" opacity="1" stroke="none"/></g></svg>
  </div></div></div>
  ...
  <div class="news-box-wrapper">
    <div class="news-box" style="background-color: #141C28;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: larger; color:#FF8902;">
        <b>Vacature: Financieel Manager</b>
        </p>
      </div>
      <div class="box-progress-wrapper">
    <p class="news-box-text">Vanaf nu kan je je aanmelden voor de managementfunctie: Financieel Manager. Voor meer informatie over de functie of om je aan te melden kan je een mail naar mij sturen of langskomen voor meer informatie.</p><br>
    <p class="news-box-text-footer" style="opacity:50%;"><b>Tristan Verschueren</b><br>10 maart 2023</p>
    <svg height="32px" width="30px" class="ivs-logo-news" stroke-miterlimit="10" style="fill-rule:nonzero;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;" version="1.1" viewBox="0 0 900 900" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:vectornator="http://vectornator.io" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs/><g id="Layer-1" vectornator:layerName="Layer 1"><path d="M706.154 46.058C693.344 46.2158 682.435 50.4501 682.435 50.4501C682.435 50.4502 580.161 79.1179 421.76 202.338C332.101 272.084 148.257 426.768 151.163 487.428C152.281 510.757 242.646 584.622 370.369 679.723C498.357 775.022 677.087 849.978 677.087 849.978C677.087 849.978 734.881 866.303 745.143 832.729C758.532 788.926 725.455 775.552 725.455 775.552L653.368 739.616C653.368 739.616 749.855 594.88 748.863 448.218C747.872 301.556 649.647 152.907 649.647 152.907L724.68 117.77C724.68 117.769 760.266 100.774 742.43 66.4215C733.862 49.9188 718.964 45.9002 706.154 46.058ZM565.933 205.133C565.933 205.133 580.941 213.132 590.738 227.892C600.535 242.653 605.232 264.147 605.232 264.147C605.232 264.147 465.594 359.509 465.089 464.668C464.5 587.536 603.604 663.832 603.605 663.832C603.605 663.832 597.658 676.936 589.652 687.949C581.647 698.961 571.592 707.753 571.592 707.753C571.592 707.753 255.263 510.829 255.263 475.689C255.263 432.162 565.934 205.133 565.933 205.133ZM637.555 341.928C637.555 341.928 648.252 368.508 648.252 464.668C648.252 537.742 637.555 587.408 637.555 587.409C637.555 587.409 554.781 526.152 554.694 464.668C554.621 413.141 637.555 341.928 637.555 341.928Z" fill="#FF8902" fill-rule="nonzero" opacity="1" stroke="none"/></g></svg>
  </div></div></div>

  <div class="navigatie-box-wrapper">
    <div class="news-box" style="background-color: #FF8902; height: 254px;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: x-large; color:#fffff;">
        <b>Snel navigeren</b>
        </p>

        <div class="inside-nav-box-wrapper">
    <div class="inside-nav-box" style="background-color: #141C28; margin-bottom: 10px;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: large; color:#fffff;">
        <b>Projecten</b></p>
        <p class="inside-nav-box-tekst" style="font-size: small;">Status van nu lopende en afgeronde projecten bekijken.</p>
      </div></div>

    <div class="inside-nav-box" style="background-color: #141C28;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: large; color:#fffff;">
        <b>Tickets</b></p>
        <p class="inside-nav-box-tekst" style="font-size: small;">Status van alle openstaande en afgeronde tickets bekijken.</p>
      </div></div></div>

      <div class="inside-nav-box-wrapper2">
    <div class="inside-nav-box" style="background-color: #141C28; margin-bottom: 10px;">
      <div class="news-box-content-header">
        <p class="box-content-header" style="font-size: large; color:#fffff;">
        <b>Templates</b></p>
        <p class="inside-nav-box-tekst" style="font-size: small;">Documenten voor je project nodig? Je kan de templates via hier downloaden.</p>
      </div></div>

    <div class="inside-nav-box" style="background-color: #141C28;">
      <div class="news-box-content-header">
      <p class="box-content-header" style="font-size: large; color:#fffff;">
        <b>Ruimte reserveren</b></p>
        <p class="inside-nav-box-tekst" style="font-size: small; margin-top:0px;">Wordt binnenkort toegevoegd</p>
      </div> </div></div> 
      ...
      <div class="box-progress-wrapper">
                    ...
                    <article class="box-admin-portaal">
                        <h1>Projecten</h1>
                        <p>Status van alle nu lopende en afgeronde<br> IVS projecten bekijken.</p>
                        <button onclick="window.location='projects.php';" class="breakout-button" type="button">Naar
                            projecten</button>
                    </article>

                    <article class="box-admin-portaal">
                        <h1>Tickets</h1>
                        <p>Status van alle openstaande en<br> afgeronde tickets bekijken.</p>
                        <button onclick="window.location='tickets.php';" class="breakout-button" type="button">Naar
                            tickets</button>
                    </article>

                    <article class="box-admin-portaal">
                        <h1>Templates</h1>
                        <p>Documenten voor je project nodig? <br>Je kan de templates via hier downloaden.</p>
                        <a href="templates.php"><button class="breakout-button" style="margin-top:16px;"
                                type="button">Naar templates</button></a>
                    </article>

                    <article class="box-admin-portaal">
                        <h1>Product aanvraag</h1>
                        <p>Wil je een product lenen voor een project? <br>Dan kan je deze hier aanvragen.</p>
                        <a href="uitleen_aanvraag_formulier.php"><button class="breakout-button"
                                style="margin-top:16px;" type="button">Naar formulier</button></a>
                    </article>
                    ...
                    <div class="projects-section-header-home" style="width:100%;">
                        <h2>Jouw projecten</h2><br>
                        <p>Je werkt op dit moment aan <?php echo $resultCheck; ?> <?php echo $projectenkelvoud; ?>.</p>
                        <br>
                    </div>
        ...
        while($row = mysqli_fetch_assoc($result)) {
          ...
          elseif ($row['project_status'] == 'Gestopt'){
            ...
            echo'<p><b>Telefoonnummer Klant: </b><br>' , $row['telefoonnummer'] , '</p>';
            echo'<p><b>Email Klant: </b><br>' , $row['emailklant'] , '</p>';
            ...
            echo'<p class="opmerkingenveld" style="white-space:pre-wrap;">' , $row['opmerkingen'] , '</p>';
            echo'</div>';
      ...
      ?>
                    ...
                    <div class="projects-section-header-home" style="width:100%;">
                        <h2>Jouw tickets</h2><br>
                        <p>Er <?php echo $zijnis; ?> op dit moment <?php echo $resultCheckTickets; ?>
                            <?php echo $ticketmeervoud; ?> bij jou ingepland.</p><br>
                    </div>
      ...
      while($row = mysqli_fetch_assoc($tickets)) {
        ...
        echo'<p class="box-content-header" style="font-size: larger; color: ',$barcolor,';"><b>' , $row['projectnaam'] , '</b></p>';
        echo'<p class="box-content-subheader">' , $row['korte'] , '</p>';
        echo'</div>';

        echo'<div class="box-progress-wrapper">';
        echo'<p class="box-progress-text"><b>Ticketbeheerder: </b>' , $row['beheerder'] , '</p>';
        echo'<p class="box-progress-text"><b>Klant: </b>' , $row['klant'] , '</p><br>';
    ...
    ?>
                        <h2>Jouw Aanvragen</h2><br>
                        <p>Je hebt <?php echo $resultCheckAanvragen; ?> <?php echo $aanvraagenkelvoud; ?>.</p><br>
                    </div>

                    <?php
// Define the number of requests per page
$requestsPerPage = 6;
$requestsPerRow = 3;
...
if ($result) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Close the row after every 3 requests
        if (($counter + 1) % $requestsPerRow === 0 || ($counter + 1) === $requestsPerPage) {
    ...
    // Close the row if the number of requests is not a multiple of 3
    if ($counter % $requestsPerRow !== 0) {
        echo '</div>'; // Close the row div
    }
    ...
    $queryCount = "SELECT COUNT(*) AS total FROM aanvragen WHERE user_id = $userId";
    $resultCount = $conn->query($queryCount);
    $rowCount = $resultCount->fetch_assoc()['total'];

    // Calculate the total number of pages
    $totalPages = ceil($rowCount / $requestsPerPage);

      // Display pagination links
      echo '<div class="pagination-container">';
      echo '<div class="requests-pagination">';
      if ($totalPages > 1) {
          $prevPage = ($page > 1) ? $page - 1 : 1;
          $nextPage = ($page < $totalPages) ? $page + 1 : $totalPages;
      
          $prevOpacity = ($page == 1) ? 'low-opacity' : '';
          $nextOpacity = ($page == $totalPages) ? 'low-opacity' : '';
      
          if ($page > 1) {
              echo '<a href="?page=' . $prevPage . '#requests-section" class="bracket ' . $prevOpacity . '">&lt;</a>';
          } else {
              echo '<span class="bracket ' . $prevOpacity . '">&lt;&nbsp;&nbsp;</span>';
          }
      
          // Display page links
          if ($totalPages <= 4) {
              // Show all page links if total pages are 5 or less
              for ($i = 1; $i <= $totalPages; $i++) {
                  if ($i == $page) {
                      echo '<span class="current-page">' . $i . '</span>';
                  } else {
                      echo '<a href="?page=' . $i . '#requests-section">' . $i . '</a>';
                  }
              }
          } else {
              // Show 3 page links on each side of the current page and ellipsis
              if ($page <= 3) {
                  // Show first 5 page links and ellipsis
                  for ($i = 1; $i <= 4; $i++) {
                      if ($i == $page) {
                          echo '<span class="current-page">' . $i . '</span>';
                      } else {
                  ...
                  echo '<a href="?page=' . $totalPages . '#requests-section">' . $totalPages . '</a>';
              } elseif ($page >= $totalPages - 2) {
                  // Show last 5 page links and ellipsis
                  echo '<a href="?page=1#requests-section">1</a>';
                  echo '<span class="ellipsis">...</span>';
          ...
          if ($page < $totalPages) {
              echo '<a href="?page=' . $nextPage . '#requests-section" class="bracket ' . $nextOpacity . '">&gt;</a>';
          } else {
              echo '<span class="bracket ' . $nextOpacity . '">&nbsp;&nbsp;&gt;</span>';
          }
      }
      echo '</div>';
      echo '</div>';
      
      echo '</div>'; // Closes the requests-section div
