...
<div class="item-status" style="margin-top:-5px;">
    <span class="status-type2"> <?php
      ...
      IVS Project Management Systeem</span>
  </div>
  ...
  <div class="app-sidebar">
    ...
    <script src="https://cdn.jsdelivr.net/prefixfree/1.0.7/prefixfree.dynamic-dom.min.js"></script>
      ...
      <form action="generalauthenticate.php" method="post">
        <div class="login-box">
        <h2 style="margin-top: -10px;">Inloggen</h2>
        ...
        <input class="projectstatusbutton" style="margin-top: 10px;" type="submit" name="login_user" value="Inloggen">
        </div><br>
      </form>

      <img class="mockup_img" src="img/pms_macbook_mockup.png">

      <!-- Account registreren -->
      <form name="register" action="" method="post" style="position: absolute; margin-top: 200px;">
        <div class="login-box">
        <h2 style="margin-top: 15px;">Account aanvragen</h2>
        <p class="infobijlogin">Heb je nog geen PMS account? Vraag deze dan nu aan.<br>Zo kan je altijd projecten, tickets, templates en meer bekijken.</p>

        <div class="regbox">
        <p class="boveninlogp_reg">Volledige naam</p>
          <div class="textbox_login_reg">
            <input type="text" placeholder="Voornaam Achternaam" name="naam" id="naam" value="" required>
            <i class="fa fa-signature" aria-hidden="true"></i>
          </div>
          
        <p class="boveninlogp_reg">Scalda Email</p>
          <div class="textbox_login_reg">
            <input type="email" placeholder="naam@email.com" name="email" id="email" value="" required>
            <i class="fa fa-at" aria-hidden="true"></i>
          </div>

          <input type="hidden" name="accounttype" id="accounttype" value="Student">
          <input type="hidden" name="username" id="username" value="<?php echo(rand(100000000,999999999)) ?>">

        <p class="boveninlogp_reg">Er wordt een gebruikersnaam voor je gegenereerd. Deze ontvang je als je account is geactiveerd.</p>
          <input class="authbutton" style="margin-top: -42px; margin-left: 412px;" type="submit" name="reg_user" value="Account aanvragen" onclick="getElementById('username').value=Math.floor(Math.random()*10000)"></div>

        <div class="regbox">
        <p class="boveninlogp_reg">Wachtwoord</p>
          <div class="textbox_login_reg">
            <input type="password" placeholder="Wachtwoord" name="password_1" id="password_1" value="" required>
            <i class="fa fa-lock" aria-hidden="true"></i>
            </div>

        <p class="boveninlogp_reg">Wachtwoord Controle</p>
          <div class="textbox_login_reg">
            <input type="password" placeholder="Wachtwoord" name="password_2" id="password_2" value="" required>
            <i class="fa fa-lock" aria-hidden="true"></i>
            </div></div>
...
if (isset($_POST['reg_user'])) {
	...
	if ($password_1 != $password_2) {
		...
		echo'<span class="status-type"><b>Whoopsie floepsie! </b><br> Er bestaat al een account met deze gebruikersnaam. Kies een andere gebruikersnaam.<br><br>';
    ...
    <p class="inner">
      <strong>Status accountaanvraag:</strong> Er lijkt iets fout te zijn gegaan bij het indienen van je aanvraag. Dit kan komen door problemen met de server. We adviseren je het op een later moment nog eens te proberen.
    </p>
    </div>';
	  }
	}
	...
	if ($errors == 0) {
		...
		$query = "INSERT INTO users (naam, username, email, accounttype, password) VALUES('$naam', '$username', '$email' , '$accounttype' , '$password')";
    ...
    echo'<script src="https://cdnjs.cloudflare.com/ajax/libs/prefixfree/1.0.7/prefixfree.min.js"></script>
    <div class="alert2 error">
    <input type="checkbox" id="alert1" />
    <label class="close" title="close" for="alert1">
      <i class="icon-remove"></i>
    </label>
    <p class="inner">
      <strong>Status accountaanvraag:</strong> We hebben je accountaanvraag ontvangen, Voor je je account kan gebruiken moeten we je account eerst activeren. Zodra je account is goedgekeurd ontvang je hiervan via email een bevestiging. De gebruikersnaam die je moet gebruiken om in te loggen is in de meeste gevallen gewoon je voornaam. 
    </p>
    </div>';
	}
  }  
