            ...
            <div class="projects-section">
                ...
                <div class="project-boxes jsGridView">
                    ...
                    <article class="box-admin-portaal1">
                        ...
                        <p>Er zijn op dit moment <b><?php echo $resultCheck; ?></b> actieve projecten waarvan
                            <b><?php echo $resultSoftware; ?></b> software en <b><?php echo $resultMedia; ?></b>
                            mediaprojecten. Er zijn <b><?php echo $resultCombinatie; ?></b> combinatieprojecten.
                        </p>
                    ...
                    <article class="box-admin-portaal">
                        ...
                        <button onclick="window.location='admin_projecten.php';" class="breakout-button"
                            type="button">Naar projecten 📂</button>
                    </article>

                    <article class="box-admin-portaal">
                        <h1>Tickets beheren</h1>
                        <p>Status van tickets bijwerken,<br> Tickets bewerken, Etc.</p>
                        <button onclick="window.location='admin_tickets.php';" class="breakout-button"
                            type="button">Naar tickets 🎟</button>
                    </article>

                    <article class="box-admin-portaal">
                        <h1>Accounts beheren</h1>
                        <p>Admin en gebruiker accounts beheren<br>& Accountoverzicht</p>
                        <button onclick="window.location='registreren.php';" class="breakout-button" type="button">Naar
                            accounts 👥</button>
                    </article>
...
?>
                    ...
                    <article class="box-admin-portaal">
                        ...
                        <button onclick="window.location='newticket.php';" class="breakout-button" type="button">Ticket
                            toevoegen ➕</button>
                    </article>
