...
$sql = "SELECT * FROM `project` WHERE project_status='Bezig' ORDER BY projectnaam;";

$bezig = mysqli_query($conn, $sql);
$resultBezig = mysqli_num_rows($bezig);


$sql = "SELECT * FROM `project` WHERE project_status='Factuur' ORDER BY projectnaam;";
...
$sql = "SELECT * FROM `project` WHERE project_status='Wacht op start' ORDER BY projectnaam;";

$wachtopstart = mysqli_query($conn, $sql);
$resultWachtopstart = mysqli_num_rows($wachtopstart);


$sql = "SELECT * FROM `project` WHERE project_status='Initiatie' ORDER BY projectnaam;";

$initiatie = mysqli_query($conn, $sql);
$resultInitiatie = mysqli_num_rows($initiatie);


$sql = "SELECT * FROM `project` WHERE project_status='On Hold' ORDER BY projectnaam;";

$hold = mysqli_query($conn, $sql);
$resultHold = mysqli_num_rows($hold);

$sql = "SELECT * FROM `project` WHERE project_status='Gestopt' ORDER BY projectnaam;";
...
$sql = "SELECT * FROM `project` WHERE `projectnaam` LIKE '%".$searchresult."%' OR `projectleider` LIKE '%".$searchresult."%' OR `klant` LIKE '%".$searchresult."%' OR `projectleden` LIKE '%".$searchresult."%' ORDER BY projectnaam;";
...
<div class="item-status" style="margin-top:-5px;">
    <span class="status-type2"> <?php
      ...
      Je bekijkt de <b>Projectpagina</b></span>
  </div>
...
<a class="mode-switch" title="Switch Theme">
  ...
  <div class="projects-section">
    <div class="projects-section-header">
      <p>Projecten Innovision Solutions</p>
    ...
    <div class="projects-section-line">
      ...
      <div class="item-status">
        ...
        <div class="status-type"><span class="bezig" style="background: #E66600"><?php echo $resultInitiatie; ?></span><input type="submit" class="filterbutton" name="initiatie" value="Initiatie" style="text-overflow: ellipsis;"><i class="fa-solid fa-arrow-right" style="color:white; margin-left:6px;"></i></div>
        <div class="status-type"><span class="bezig" style="background: #3182B5"><?php echo $resultAfwachting; ?></span><input type="submit" class="filterbutton" name="afwachting" value="In Afwachting"><i class="fa-solid fa-arrow-right" style="color:white; margin-left:6px;"></i></div>
        <div class="status-type"><span class="bezig" style="background: #00A319;"><?php echo $resultBezig; ?></span><input type="submit" class="filterbutton" name="bezig" value="Bezig"><i class="fa-solid fa-arrow-right" style="color:white; margin-left:6px;"></i></div>
        ...
        <div class="status-type"><span class="bezig" style="background: #9B59B5"><?php echo $resultFactuur; ?></span><input type="submit" class="filterbutton" name="factuur" value="Factuur"><i class="fa-solid fa-arrow-right" style="color:white; margin-left:6px;"></i></div>
        <div class="status-type" style="margin-right:0px;"><span class="bezig" style="background: #1D8068"><?php echo $resultAfgerond; ?></span><input type="submit" class="filterbutton" name="afgerond" value="Afgerond"></div>
        ...
        <div class="status-type" style="margin-left:10px;"><span class="bezig" style="background: #FFFFFF"><?php echo $resultCheck; ?></span><a href="projects.php" class="filterbutton"><b style="margin-right:5px;"> Totaal Actief</b></a></div>
      </div>
    </div>
