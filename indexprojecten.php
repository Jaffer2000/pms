...
$sql = "SELECT * FROM `project` WHERE `projectleider` LIKE '%".$persoonlijkepagina."%' OR `projectleden` LIKE '%".$persoonlijkepagina."%' OR `emailklant` LIKE '%".$persoonlijkepagina."%' OR `telefoonnummer` LIKE '%".$persoonlijkepagina."%' OR `projectcoach` LIKE '%".$persoonlijkepagina."%';";
      ...
      $persoonlijkepagina = $_SESSION['name'];
        ...
        while($row = mysqli_fetch_assoc($rows))
        {
          ...
          if ($row['accounttype'] == 0){
            $accounttype = 'Account niet actief';
          }
          ...
          echo'<p><b>Soort account: </b><br>', $accounttype , '</p><br>';

          echo'<i class="fa-solid fa-user"><a href="logout.php"> Account aanpassen</a></i><br><br>';
...
<div class="alert error">
      ...
      <p class="inner">
        <strong>Problemen Chrome MacOS:</strong> Er zijn problemen met het inladen van delen van de styling waardoor maar een deel van de projecten zichtbaar is. We adviseren je om op MacBooks gebruik te maken van Safari of FireFox. Voor zover bekend komt dit probleem alleen voor op MacOS devices in combinatie met de Google Chrome browser.
      </p>
    </div>
    ...
    <div class="projects-section-line">
      ...
      if (isset($_POST["projecten"])) {
          ...
          while($row = mysqli_fetch_assoc($tickets)) {
            ...
            echo'<p style="margin-bottom: 5px;"><b>Opmerkingen en updates: </b></p>';
          ...
          while($row = mysqli_fetch_assoc($result)) {
            ...
            echo'<p><b>Klant: </b><br><i>' , $row['klant'] , '</i></p>';
            echo'<p><b>Projectcoach: </b><br><i>' , $row['projectcoach'] , '</i></p>';
            echo'<p><b>Telefoonnummer Klant: </b><br><i>' , $row['telefoonnummer'] , '</i></p>';
            echo'<p><b>Email Klant: </b><br><i>' , $row['emailklant'] , '</i></p>';
