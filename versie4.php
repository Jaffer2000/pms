...
<h2>IVS PMS Versie 4.0</h2><br><p>Nieuwe dingen en verbeteringen in versie 4.0</p><br><br>

<p>- Telling van actieve projecten is gecorrigeerd. Nu valt er onder actief: Bezig, Factuur, In Afwachting, Wacht op start en Initiatie.<br>
- Accounts beheren pagina is verbeterd en heeft een duidelijker uiterlijk gekregen.<br>
- Bij het aanmaken van een admin account is het niet meer nodig om een extra account aan te maken. Bij het aanmaken van een admin account wordt ook automatisch een gebruiker account aangemaakt die wordt gekoppeld aan het admin account dezelfde gebruikersnaam.<br><br>
- Accountgegevens zijn nu aanpasbaar. (Voor nu alleen nog admin accounts).<br>
- Accounts hebben nu meer gegevens: Gebruikersnaam, Naam, Email, Accounttype / Functie.<br>
- Je kan iemand de admin rechten ontnemen inplaats van heel het account verwijderen.<br>
- Zoekbalken zijn weggehaald op pagina’s waar niet gezocht kan worden.<br>
- Op de homepage staat nu overzichtelijk informatie over waar je mee bezig bent en kun je makkelijk navigeren naar de projecten / ticketspagina. Ook is er een link naar de templates website.<br><br>
- In de infokolom onder de datum wordt nu aangegeven op welke pagina je je bevindt.<br>
- Het nieuwe IVS logo is overal toegepast.<br>
- Darkmode/Lightmode switch is verhuisd naar linksonder om ruimte te maken voor de accountgegevens.<br>
- Bug met laatst gewijzigd is opgelost. Geeft nu normale tijd aan.<br>
- De pagina project toevoegen is vervangen door een popup-modal waarin je alle gegevens kan invullen net zoals bij het bewerken van een project. (Voor tickets toevoegen volgt dit ook nog).<br><br>
- Probleem met opmerkingenveld is opgelost. Nu scrolt de tekst mee i.p.v. de hele modal. Dit voorkomt bugs met styling etc.<br>
- Je kan nu zelf een account aanvragen zonder dat je ingelogd moet zijn.<br>
- Project/ticketblokken hebben een moderner uiterlijk gekregen met de projectnaam of ticketnaam in grotere letters.<br>
- Nieuw algemeen font IVS. Vanaf nu gebruiken we op elk IVS platform wat aan de PMS is gelinkt hetzelfde font. Dus ook de templates website.<br>
- Diverse kleinere bugs zijn opgelost.<br>
- Kleine aanpassingen in styling: Margin, padding, Etc.<br><br>

<b>Mocht je dingen tegenkomen die niet goed of helemaal niet werken laat dit dan graag zo snel mogelijk weten zodat we dit kunnen oplossen.<b></p>
