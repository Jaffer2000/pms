      ...
      echo " <b>" . $datetime . "</b>";?><br>
                ...
                <div class="search-wrapper">
                    <form action="" method="GET">
                        <input class="search-input" type="text" placeholder="Zoek in tickets..." name="search"
                            id="search" value="">
                        ...
                        <div class="item-status">
                            <form action="" method="post" class="statusformulier">
                                <div class="status-type"><span class="bezig"
                                        style="background: #E66600"><?php echo $resultIngediend; ?></span><input
                                        type="submit" class="filterbutton" name="ingediend" value="Ingediend"><i
                                        class="fa-solid fa-arrow-right" style="color:white; margin-left:6px;"></i></div>
                                <div class="status-type"><span class="bezig"
                                        style="background: #27C840"><?php echo $resultBezig; ?></span><input
                                        type="submit" class="filterbutton" name="bezig" value="Bezig"><i
                                        class="fa-solid fa-arrow-right" style="color:white; margin-left:6px;"></i></div>
                                <div class="status-type"><span class="bezig"
                                        style="background: #B9B9B9"><?php echo $resultAfgerond; ?></span><input
                            ...
                            <div class="status-type" style="margin-left:10px;"><span class="bezig"
                                    style="background: #FFFFFF"><?php echo $resultCheck; ?></span><a href="tickets.php"
                                    class="filterbutton"><b style="margin-right:5px;"> Totaal actief</b></a></div>
                        </div>
