...
$sql = "SELECT * FROM `project` WHERE project_status='In Afwachting' ORDER BY projectnaam;";
  ...
  <div class="projects-section">
    ...
    <div class="projects-section-line">
      ...
      <div class="item-status">
        ...
        <div class="status-type"><span class="bezig" style="background: #FFFFFF"><?php echo $resultCheck; ?></span><a href="projects.php" class="filterbutton"><b> Actieve projecten</b></a></div>
        </form>
      </div>
    </div>
