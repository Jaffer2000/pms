...
<div class="app-content">
  ...
  <div class="projects-section">
    <div class="projects-section-header">
      ...
      <a href="admin.php"><button><i class="fas fa-folder"></i> Projecten beheren</button></a>
      <a href="newticket.php"><button><i class="fas fa-plus"></i> Ticket toevoegen</button></a>
    </div>
    </div>
    <div class="projects-section-line">
      ...
      <div class="status-type"><span class="bezig" style="background: #27C840"><?php echo $resultBezig; ?></span><input type="submit" class="filterbutton" name="bezig" value="Bezig"></div>
        <div class="status-type"><span class="bezig" style="background: #E66600"><?php echo $resultIngediend; ?></span><input type="submit" class="filterbutton" name="ingediend" value="Ingediend"></div>
        <div class="status-type"><span class="bezig" style="background: #3182B6"><?php echo $resultAfgerond; ?></span><input type="submit" class="filterbutton" name="afgerond" value="Afgerond"></div>
        <div class="status-type"><span class="bezig" style="background: #FFFFFF"><?php echo $resultCheck; ?></span><a href="admin_tickets.php" class="filterbutton"><b> Totaal actief</b></a></div>
        </form>
      </div>
  ...
  <div class="project-boxes jsGridView">
      <?php
        ...
        if ($resultCheck > 0) {
          while($row = mysqli_fetch_assoc($result)) {
            ...
            if ($row[opleiding] == 'SD'){
              $opleidingcolor = '#A0D3FF';
            }
            elseif ($row[opleiding] == 'MV'){
              $opleidingcolor = '#F5C2E0';
            }
            elseif ($row[opleiding] == 'SD & MV'){
              $opleidingcolor = '#4E148C';
            }
            ...
            echo'<button type="submit" name="delete" value="delete" class="projectstatusbuttondelete" onclick="return confirm(\'Weet je zeker dat je dit ticket wilt verwijderen? Druk op OK om te verwijderen.\')"; style="margin-left:5px;"><i class="fas fa-trash-alt"></i> Ticket verwijderen</button><br></form>';
            echo'</div>';
      ...
      <?php
        ...
        $sql = "UPDATE tickets SET klant='$klant', projectcoach='$projectcoach', email='$email', indiener='$indiener', beheerder='$beheerder', projectnaam='$projectnaam', ticketomschrijving='$ticketomschrijving', ticketnummer='$ticketnummer', project_status='$project_status', prio='$prio' WHERE tickets.id = $ticket_id;";
