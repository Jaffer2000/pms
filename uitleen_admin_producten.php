            ...
            <div class="projects-section">
                <div class="projects-section-header">
                    ...
                    <div class="newprojectbutton">
                        <a href="uitleen_admin_aanvragen_overzicht.php"><button> Terug naar aanvragen
                                overzicht</button></a>
                ...
                <form action="uitleen_admin_producten.php" method="post">
                    <div>
                        <input type="text" class="uitleenproducttextinput" name="naam"
                            placeholder="Voeg hier een product toe" required>
                ...
                <div class="producten">
                    <?php
                    $producten = new UitleenProduct();
                    foreach ($producten->getAllProducts() as $product) {
                        $product_id = $product['product_id'];
                        $lastLender = $producten->getLastLender($product_id);
                        ?>
                    <div class="product">
                        <form action="uitleen_admin_producten.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $product['product_id']; ?>">
                            <input type="text" class="uitleenproducttextinput" name="naam"
                                value="<?php echo htmlspecialchars($product['product_naam']); ?>" required>
